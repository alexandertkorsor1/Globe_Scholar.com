...
import { Application, ApplicationStatus, DocType } from '../../types/database';
...
export const StudentPortal: React.FC = () => {
  ...
  a => a.student_email?.toLowerCase() === currentProfile.email?.toLowerCase()
);
    ...
    >
      ...
      >
        ...
        <p style={{ color: '#94a3b8', lineHeight: 1.6 }}>
          We could not find an application associated with:
        </p>
        ...
        >
          Please complete your application or contact the administrator.
        </p>
      </div>
    </div>
  );
