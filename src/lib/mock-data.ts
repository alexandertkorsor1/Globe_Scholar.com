...
export const INITIAL_STUDENTS: Student[] = [
  {
    ...
    age: 23,
    gender: 'Male',
    current_address: '42 Park Street, New Delhi, India',
  ...
  },
  {
    ...
    age: 21,
    gender: 'Female',
    current_address: '18 Victoria Island Road, Lagos, Nigeria',
  ...
  },
  {
    ...
    age: 24,
    gender: 'Male',
    current_address: 'Rua Augusta 1200, São Paulo, Brazil',
  ...
  },
  {
    ...
    age: 22,
    gender: 'Female',
    current_address: 'Via Roma 28, Milan, Italy',
...
export const INITIAL_FINANCIAL_RECORDS: FinancialRecord[] = [
  {
    ...
    verified_at: '2026-03-01T10:48:00Z',
...
export const INITIAL_DEPARTMENT_KPIS: DepartmentKpiRecord[] = [
  {
    id: 'kpi-001',
    evaluation_period: '2026-03',
    staff_name: 'David Chen',
    staff_email: 'david.data@globescholar.org',
    department: 'data_applications',
    role_title: 'Senior Data & Applications Officer',
    kpi_lead_management: 18,
    kpi_conversion: 21,
    kpi_communications: 14,
    kpi_reporting: 13,
    kpi_teamwork: 9,
    kpi_discipline: 14,
    total_score: 89,
    ...
    monthly_report_submitted: true,
    consecutive_missed_reports: 0,
    formal_review_required: false,
    notes_actions: 'Strong document verification turnaround. Continue improving CRM follow-up notes.',
    created_by: 'usr-ops-01',
    created_by_name: 'Olivia Martinez',
  ...
  },
  {
    id: 'kpi-002',
    evaluation_period: '2026-03',
    staff_name: 'Marcus Brody',
    staff_email: 'marcus.admissions@globescholar.org',
    department: 'admissions',
    role_title: 'Admissions Lead',
    kpi_lead_management: 16,
    kpi_conversion: 22,
    kpi_communications: 13,
    kpi_reporting: 12,
    kpi_teamwork: 8,
    kpi_discipline: 13,
    total_score: 84,
    ...
    consecutive_missed_reports: 1,
    formal_review_required: false,
    notes_actions: 'Monthly report needs to be closed earlier before final review meetings.',
    created_by: 'usr-ops-01',
    created_by_name: 'Olivia Martinez',
    created_at: '2026-03-31T17:10:00Z',
    updated_at: '2026-03-31T17:10:00Z',
  },
  {
    id: 'kpi-003',
    evaluation_period: '2026-03',
    staff_name: 'Fiona Gallagher',
    staff_email: 'fiona.finance@globescholar.org',
    department: 'finance',
    role_title: 'Finance Lead',
    kpi_lead_management: 17,
    kpi_conversion: 20,
    kpi_communications: 15,
    kpi_reporting: 14,
    kpi_teamwork: 9,
    kpi_discipline: 15,
    total_score: 90,
    ...
    consecutive_missed_reports: 0,
    formal_review_required: false,
    notes_actions: 'Payment verification and receipt workflow running cleanly.',
    created_by: 'usr-ops-01',
    created_by_name: 'Olivia Martinez',
    created_at: '2026-03-31T17:20:00Z',
    updated_at: '2026-03-31T17:20:00Z',
  }
];
...
export const INITIAL_PAYMENT_RECEIPTS: PaymentReceipt[] = [
  {
    id: 'rcpt-001',
    receipt_number: 'GSP-RCPT-2026-0001',
    financial_record_id: 'fin-001',
    application_id: 'app-001',
    application_number: 'GS-2026-1023',
    student_id: 'std-001',
    student_name: 'Arjun Patel',
    ...
    currency: 'USD',
    payment_reference: 'PAY-STRIPE-8912039',
    issued_by: 'usr-fin-01',
    issued_by_name: 'Fiona Gallagher (Finance)',
    issued_at: '2026-03-01T10:50:00Z',
    status: 'issued',
    notes: 'Receipt generated after Finance verified the registration fee.',
